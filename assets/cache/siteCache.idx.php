...
$m[] = array('0' => '1');
$d['remont-skuterov'] = 2;
$a[2] = array('id' => 2, 'alias' => 'remont-skuterov', 'path' => '', 'parent' => 0, 'isfolder' => 1);
$m[] = array('0' => '2');
$d['remont_velosipedov_brovary'] = 3;
$a[3] = array('id' => 3, 'alias' => 'remont_velosipedov_brovary', 'path' => '', 'parent' => 0, 'isfolder' => 1);
$m[] = array('0' => '3');
...
';
$c['CONTENT_PRODUCTS'] = '<section id="content" class="content-subpages">
      <div>
      	<div class="wrap">
...
$c['tpl.Wayfinder.outer'] = '[+wf.wrapper+]';
$c['tpl.Wayfinder.row.parent'] = '<li class="nav-item dropdown">
<a href="[+wf.link+]"class="dropdown-toggle" data-hover="dropdown" data-delay="0" data-close-others="false" title="[+wf.title+]"><i></i> [+wf.linktext+] </a>
<ul class="dropdown-menu" style="display: none;">
[+wf.wrapper+]
</ul>
</li>';
$c['tpl.Wayfinder.row.inner'] = '<li [+wf.classes+]>
<a href="[+wf.link+]" [+wf.attributes+]>[+wf.linktext+]</a>
[+wf.wrapper+]
</li>';
$c['tpl.Wayfinder.row'] = '<li class="nav-item">
<a href="[+wf.link+]" [+wf.attributes+]>[+wf.linktext+]</a>
[+wf.wrapper+]
</li>';
$c['Pro HEADER'] = '<header>
...
';
$c['Duplicate of MENU'] = '<div class="nav-shadow">
      	<div>
          <nav>
              <ul class="menu">
				  [!Wayfinder? &startId=`0` &level=`1`!] 
...
';
$c['pro MENU'] = '<div class="nav-shadow">
      	<div>
          <nav>
              <ul class="menu">
				  [!Wayfinder? &startId=`0` &level=`1`!] 
...
$mainpage = $modx->getConfig(\'site_start\');
	...
	case \'ulli\': // UL List
		...
		foreach ($docs as $doc)
		{
			...
			if ($doc[\'id\']!=$mainpage){
				...
				$s .= "<a href=\\"[(site_url)]\\" class=\\"sitemap\\">" . $doc[\'pagetitle\'] . "</a>";
			}
			$s .= "</li>\\n";
			$output .= $s;
		} // end foreach
